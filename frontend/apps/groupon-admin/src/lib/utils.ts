...
export const setCookie = (res: NextApiResponse, value: string, options: Partial<CookieSerializeOptions> = {}) => {
  ...
  res.setHeader('Set-Cookie', serialize(AUTH_COOKIE_NAME, value, finalOptions));
};
