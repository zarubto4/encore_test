...
export namespace gatewayService_streamLine {
    ...
    export class ServiceClient {
         ...
         */
        public async websocket(params: models.StreamLineDefaultHandshake): Promise<StreamInOut<models.StreamLineDefaultInMessage, models.StreamLineDefaultOutMessage>> {
...
export namespace transformationService_bigPicture {
    ...
    export class ServiceClient {
         ...
         */
        public async createProductRoadmap(params: models.TransformationBigPictureUniversalRequest): Promise<models.TransformationBigPictureUniversalResponse> {
            // Now make the actual call to the API
