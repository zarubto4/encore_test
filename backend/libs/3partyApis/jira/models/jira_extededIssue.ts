...
export class ExtendedIssue {
  ...
  get quartalTags(): string {
    const labels: string[] = [];
    if (this.labels.includes("24Q1")) {
      labels.push("24Q1");
    }
    if (this.labels.includes("24Q2")) {
      labels.push("24Q2");
    }
    if (this.labels.includes("24Q3")) {
      labels.push("24Q3");
    }
    if (this.labels.includes("24Q4")) {
      labels.push("24Q4");
    }
    if (this.labels.includes("25Q1")) {
      labels.push("25Q1");
    }
    if (this.labels.includes("25Q2")) {
      labels.push("25Q2");
    }
    if (this.labels.includes("25Q3")) {
      labels.push("25Q3");
    }
    if (this.labels.includes("25Q4")) {
      labels.push("25Q4");
    }
